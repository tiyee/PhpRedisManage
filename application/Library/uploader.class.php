...
class uploader
{
     ...
     */
    public function __construct( $file , $config , $base64 = false )
    {
        $this->file = $file;
        $this->config = $config;
    ...
    private function upFile( $base64 )
    {
        ...
        if ( !$this->checkSize() ) {
         ...
         if ( !$this->checkWidth() ) {
            $this->stateInfo = $this->getStateInfo( "WIDTH" );
            return;
        }
    ...
    private function  checkWidth()
    {
        ...
        return $this->fileWidth <= ( $this->config[ "maxWidth" ] );
    }
